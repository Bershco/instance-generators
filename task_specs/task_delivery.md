# Task: Implement delivery instance generator
...
git checkout main
git pull --ff-only
git checkout -b feature/delivery-generator
```
...
- `problem_generator/delivery/template.pddl`
- `problem_generator/delivery/generator.py`
...
- Search recursively under `problems/numeric/delivery/`
...
locations, packages, vehicles or carriers if present, delivery-related numeric fluents, initialization patterns, and goals
...
```bash
git add problem_generator/delivery/template.pddl
git commit -m "Add template.pddl for delivery"
git push -u origin feature/delivery-generator
```
...
```bash
git add problem_generator/delivery/generator.py
git commit -m "Add generator.py for delivery"
git push
```
...
```bash
gh pr create --title "Add delivery generator" --body "Adds template and generator implementation for delivery"
```
