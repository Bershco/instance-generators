# Task: Implement fo-counters instance generator
...
git checkout main
git pull --ff-only
git checkout -b feature/fo-counters-generator
```
...
- `problem_generator/fo-counters/template.pddl`
- `problem_generator/fo-counters/generator.py`
...
- Search recursively under `problems/numeric/fo-counters/`
...
counters, numeric target/value structure, recurrent initialization patterns, equalities/targets in goals, and naming conventions
...
```bash
git add problem_generator/fo-counters/template.pddl
git commit -m "Add template.pddl for fo-counters"
git push -u origin feature/fo-counters-generator
```
...
```bash
git add problem_generator/fo-counters/generator.py
git commit -m "Add generator.py for fo-counters"
git push
```
...
```bash
gh pr create --title "Add fo-counters generator" --body "Adds template and generator implementation for fo-counters"
```
