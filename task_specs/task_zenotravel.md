# Task: Implement zenotravel instance generator
...
git checkout main
git pull --ff-only
git checkout -b feature/zenotravel-generator
```
...
- `problem_generator/zenotravel/template.pddl`
- `problem_generator/zenotravel/generator.py`
...
- Search recursively under `problems/numeric/zenotravel/`
...
cities, aircraft, people, fuel-related numeric fluents, travel graph or distance patterns, and goals
...
```bash
git add problem_generator/zenotravel/template.pddl
git commit -m "Add template.pddl for zenotravel"
git push -u origin feature/zenotravel-generator
```
...
```bash
git add problem_generator/zenotravel/generator.py
git commit -m "Add generator.py for zenotravel"
git push
```
...
```bash
gh pr create --title "Add zenotravel generator" --body "Adds template and generator implementation for zenotravel"
```
